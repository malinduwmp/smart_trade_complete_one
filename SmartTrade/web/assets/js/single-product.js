async function loadProduct() {
    ...
    if (parameters.has("pid")) {
        ...
        if (response.ok) {
            ...
            document.getElementById("thumbnail1").href = "product-images/" + id + "/image1.png";
            ...
            document.getElementById("thumbnail2").href = "product-images/" + id + "/image2.png";
            ...
            document.getElementById("thumbnail3").href = "product-images/" + id + "/image3.png";
